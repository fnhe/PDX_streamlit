...
st.text('The raw sequencing data are available at EGA (EGAS00001006710). The processed data, including deidentified clinical data, mutations, copy number, and gene expression can be found on synapse (syn35811916). ')
